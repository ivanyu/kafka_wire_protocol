...
/// ConsumerGroupDescribeResponse, version 1.
...
impl Readable for Member {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let _unknown_tagged_fields = read_tagged_fields(input, tagged_fields_callback)?;
        Ok(Member {
            member_id, instance_id, rack_id, member_epoch, client_id, client_host, subscribed_topic_names, subscribed_topic_regex, assignment, target_assignment, member_type, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ConsumerGroupDescribeResponse>("ConsumerGroupDescribeResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ConsumerGroupDescribeResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ConsumerGroupDescribeResponse", 1);
        }
    }
}
