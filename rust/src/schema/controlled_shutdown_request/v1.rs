...
/// ControlledShutdownRequest, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ControlledShutdownRequest>("ControlledShutdownRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ControlledShutdownRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ControlledShutdownRequest", 1);
        }
    }
}
