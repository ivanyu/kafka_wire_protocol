...
/// BrokerRegistrationRequest, version 1.
...
impl BrokerRegistrationRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(broker_id: i32, cluster_id: S1, incarnation_id: Uuid, listeners: Vec<Listener>, features: Vec<Feature>, rack: Option<S2>, is_migrating_zk_broker: bool) -> Self {
        Self {
            broker_id,
...
impl Readable for BrokerRegistrationRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(BrokerRegistrationRequest {
            broker_id, cluster_id, incarnation_id, listeners, features, rack, is_migrating_zk_broker, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<BrokerRegistrationRequest>("BrokerRegistrationRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: BrokerRegistrationRequest) {
            crate::test_utils::test_java_arbitrary(&data, "BrokerRegistrationRequest", 1);
        }
    }
}
