...
/// BrokerRegistrationRequest, version 4.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<BrokerRegistrationRequest>("BrokerRegistrationRequest", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: BrokerRegistrationRequest) {
            crate::test_utils::test_java_arbitrary(&data, "BrokerRegistrationRequest", 4);
        }
    }
}
