...
impl Readable for StopReplicaResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let partition_errors = read_array::<StopReplicaPartitionError>(input, "partition_errors", true)?;
...
/// StopReplicaPartitionError, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<StopReplicaResponse>("StopReplicaResponse", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: StopReplicaResponse) {
            crate::test_utils::test_java_arbitrary(&data, "StopReplicaResponse", 3);
        }
    }
}
