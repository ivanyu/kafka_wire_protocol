...
/// OffsetCommitRequest, version 10.
...
/// OffsetCommitRequestTopic, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl OffsetCommitRequestTopic {
    pub fn new(topic_id: Uuid, partitions: Vec<OffsetCommitRequestPartition>) -> Self {
        Self {
            topic_id,
            partitions,
            _unknown_tagged_fields: vec![],
...
/// OffsetCommitRequestPartition, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetCommitRequest>("OffsetCommitRequest", 10);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetCommitRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetCommitRequest", 10);
        }
    }
}
