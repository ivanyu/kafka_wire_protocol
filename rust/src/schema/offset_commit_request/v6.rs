...
/// OffsetCommitRequestTopic, version 6.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// OffsetCommitRequestPartition, version 6.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetCommitRequest>("OffsetCommitRequest", 6);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetCommitRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetCommitRequest", 6);
        }
    }
}
