...
impl OffsetCommitRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(group_id: S1, generation_id_or_member_epoch: i32, member_id: S2, topics: Vec<OffsetCommitRequestTopic>) -> Self {
        Self {
...
impl Readable for OffsetCommitRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(OffsetCommitRequest {
            group_id, generation_id_or_member_epoch, member_id, topics
        })
    }
}
...
impl OffsetCommitRequestPartition {
    pub fn new<S1: AsRef<str>>(partition_index: i32, committed_offset: i64, commit_timestamp: i64, committed_metadata: Option<S1>) -> Self {
        Self {
            partition_index,
            committed_offset,
            commit_timestamp,
...
impl Writable for OffsetCommitRequestPartition {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        self.commit_timestamp.write(output)?;
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetCommitRequest>("OffsetCommitRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetCommitRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetCommitRequest", 1);
        }
    }
}
