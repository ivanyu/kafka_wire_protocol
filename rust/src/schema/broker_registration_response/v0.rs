...
/// BrokerRegistrationResponse, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<BrokerRegistrationResponse>("BrokerRegistrationResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: BrokerRegistrationResponse) {
            crate::test_utils::test_java_arbitrary(&data, "BrokerRegistrationResponse", 0);
        }
    }
}
