...
/// BrokerRegistrationResponse, version 4.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<BrokerRegistrationResponse>("BrokerRegistrationResponse", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: BrokerRegistrationResponse) {
            crate::test_utils::test_java_arbitrary(&data, "BrokerRegistrationResponse", 4);
        }
    }
}
