...
/// SaslHandshakeResponse, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<SaslHandshakeResponse>("SaslHandshakeResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: SaslHandshakeResponse) {
            crate::test_utils::test_java_arbitrary(&data, "SaslHandshakeResponse", 0);
        }
    }
}
