...
/// AddOffsetsToTxnRequest, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddOffsetsToTxnRequest>("AddOffsetsToTxnRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddOffsetsToTxnRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AddOffsetsToTxnRequest", 1);
        }
    }
}
