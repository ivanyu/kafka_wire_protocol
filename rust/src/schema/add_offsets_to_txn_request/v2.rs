...
/// AddOffsetsToTxnRequest, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddOffsetsToTxnRequest>("AddOffsetsToTxnRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddOffsetsToTxnRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AddOffsetsToTxnRequest", 2);
        }
    }
}
