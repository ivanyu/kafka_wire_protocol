...
/// AddOffsetsToTxnRequest, version 4.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddOffsetsToTxnRequest>("AddOffsetsToTxnRequest", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddOffsetsToTxnRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AddOffsetsToTxnRequest", 4);
        }
    }
}
