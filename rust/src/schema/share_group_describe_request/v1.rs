...
/// ShareGroupDescribeRequest, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ShareGroupDescribeRequest>("ShareGroupDescribeRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ShareGroupDescribeRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ShareGroupDescribeRequest", 1);
        }
    }
}
