...
/// DeleteGroupsResponse, version 1.
...
/// DeletableGroupResult, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteGroupsResponse>("DeleteGroupsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteGroupsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteGroupsResponse", 1);
        }
    }
}
