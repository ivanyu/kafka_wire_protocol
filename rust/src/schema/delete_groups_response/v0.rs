...
/// DeleteGroupsResponse, version 0.
...
impl Readable for DeleteGroupsResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let results = read_array::<DeletableGroupResult>(input, "results", false)?;
...
/// DeletableGroupResult, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteGroupsResponse>("DeleteGroupsResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteGroupsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteGroupsResponse", 0);
        }
    }
}
