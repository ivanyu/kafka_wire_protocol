...
/// ListOffsetsTopicResponse, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// ListOffsetsPartitionResponse, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListOffsetsResponse>("ListOffsetsResponse", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListOffsetsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ListOffsetsResponse", 3);
        }
    }
}
