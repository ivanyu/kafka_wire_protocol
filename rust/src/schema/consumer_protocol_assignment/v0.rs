...
/// ConsumerProtocolAssignment, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ConsumerProtocolAssignment>("ConsumerProtocolAssignment", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ConsumerProtocolAssignment) {
            crate::test_utils::test_java_arbitrary(&data, "ConsumerProtocolAssignment", 0);
        }
    }
}
