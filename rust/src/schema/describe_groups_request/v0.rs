...
/// DescribeGroupsRequest, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeGroupsRequest>("DescribeGroupsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeGroupsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeGroupsRequest", 0);
        }
    }
}
