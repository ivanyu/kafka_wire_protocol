...
/// DescribeGroupsRequest, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeGroupsRequest>("DescribeGroupsRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeGroupsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeGroupsRequest", 2);
        }
    }
}
