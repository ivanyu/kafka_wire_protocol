...
/// DeleteRecordsResponse, version 1.
...
/// DeleteRecordsTopicResult, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// DeleteRecordsPartitionResult, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteRecordsResponse>("DeleteRecordsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteRecordsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteRecordsResponse", 1);
        }
    }
}
