...
impl SyncGroupRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(group_id: S1, generation_id: i32, member_id: S2, assignments: Vec<SyncGroupRequestAssignment>) -> Self {
        Self {
...
/// SyncGroupRequestAssignment, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<SyncGroupRequest>("SyncGroupRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: SyncGroupRequest) {
            crate::test_utils::test_java_arbitrary(&data, "SyncGroupRequest", 2);
        }
    }
}
