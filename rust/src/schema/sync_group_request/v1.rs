...
/// SyncGroupRequestAssignment, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<SyncGroupRequest>("SyncGroupRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: SyncGroupRequest) {
            crate::test_utils::test_java_arbitrary(&data, "SyncGroupRequest", 1);
        }
    }
}
