...
impl SyncGroupRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>, S3: AsRef<str>, S4: AsRef<str>, S5: AsRef<str>>(group_id: S1, generation_id: i32, member_id: S2, group_instance_id: Option<S3>, protocol_type: Option<S4>, protocol_name: Option<S5>, assignments: Vec<SyncGroupRequestAssignment>) -> Self {
        Self {
...
impl Readable for SyncGroupRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(SyncGroupRequest {
            group_id, generation_id, member_id, group_instance_id, protocol_type, protocol_name, assignments, _unknown_tagged_fields
        })
    }
}
...
/// SyncGroupRequestAssignment, version 5.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<SyncGroupRequest>("SyncGroupRequest", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: SyncGroupRequest) {
            crate::test_utils::test_java_arbitrary(&data, "SyncGroupRequest", 5);
        }
    }
}
