...
/// CreateDelegationTokenResponse, version 3.
...
impl Readable for CreateDelegationTokenResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(CreateDelegationTokenResponse {
            error_code, principal_type, principal_name, token_requester_principal_type, token_requester_principal_name, issue_timestamp_ms, expiry_timestamp_ms, max_timestamp_ms, token_id, hmac, throttle_time_ms, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateDelegationTokenResponse>("CreateDelegationTokenResponse", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateDelegationTokenResponse) {
            crate::test_utils::test_java_arbitrary(&data, "CreateDelegationTokenResponse", 3);
        }
    }
}
