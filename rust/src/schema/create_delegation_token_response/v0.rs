...
/// CreateDelegationTokenResponse, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateDelegationTokenResponse>("CreateDelegationTokenResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateDelegationTokenResponse) {
            crate::test_utils::test_java_arbitrary(&data, "CreateDelegationTokenResponse", 0);
        }
    }
}
