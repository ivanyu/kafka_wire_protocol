...
/// ListConfigResourcesResponse, version 0.
...
impl ConfigResource {
    pub fn new<S1: AsRef<str>>(resource_name: S1) -> Self {
        Self {
...
impl Readable for ConfigResource {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let _unknown_tagged_fields = read_tagged_fields(input, tagged_fields_callback)?;
        Ok(ConfigResource {
            resource_name, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListConfigResourcesResponse>("ListConfigResourcesResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListConfigResourcesResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ListConfigResourcesResponse", 0);
        }
    }
}
