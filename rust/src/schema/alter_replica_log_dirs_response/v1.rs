...
/// AlterReplicaLogDirsResponse, version 1.
...
/// AlterReplicaLogDirTopicResult, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// AlterReplicaLogDirPartitionResult, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AlterReplicaLogDirsResponse>("AlterReplicaLogDirsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AlterReplicaLogDirsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AlterReplicaLogDirsResponse", 1);
        }
    }
}
