...
/// FindCoordinatorRequest, version 6.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<FindCoordinatorRequest>("FindCoordinatorRequest", 6);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: FindCoordinatorRequest) {
            crate::test_utils::test_java_arbitrary(&data, "FindCoordinatorRequest", 6);
        }
    }
}
