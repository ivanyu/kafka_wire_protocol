...
/// FindCoordinatorResponse, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<FindCoordinatorResponse>("FindCoordinatorResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: FindCoordinatorResponse) {
            crate::test_utils::test_java_arbitrary(&data, "FindCoordinatorResponse", 2);
        }
    }
}
