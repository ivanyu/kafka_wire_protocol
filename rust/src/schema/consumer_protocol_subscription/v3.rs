...
/// ConsumerProtocolSubscription, version 3.
...
impl ConsumerProtocolSubscription {
    pub fn new<S1: AsRef<str>>(topics: Vec<String>, user_data: Option<Vec<u8>>, owned_partitions: Vec<TopicPartition>, generation_id: i32, rack_id: Option<S1>) -> Self {
        Self {
            topics,
            user_data,
            owned_partitions,
...
impl Readable for ConsumerProtocolSubscription {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let rack_id = Option::<String>::read_ext(input, "rack_id", false)?;
        Ok(ConsumerProtocolSubscription {
            topics, user_data, owned_partitions, generation_id, rack_id
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ConsumerProtocolSubscription>("ConsumerProtocolSubscription", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ConsumerProtocolSubscription) {
            crate::test_utils::test_java_arbitrary(&data, "ConsumerProtocolSubscription", 3);
        }
    }
}
