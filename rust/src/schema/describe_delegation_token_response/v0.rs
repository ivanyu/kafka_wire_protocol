...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeDelegationTokenResponse>("DescribeDelegationTokenResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeDelegationTokenResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeDelegationTokenResponse", 0);
        }
    }
}
