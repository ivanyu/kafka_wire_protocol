...
impl Readable for DescribedDelegationToken {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribedDelegationToken {
            principal_type, principal_name, issue_timestamp, expiry_timestamp, max_timestamp, token_id, hmac, renewers, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeDelegationTokenResponse>("DescribeDelegationTokenResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeDelegationTokenResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeDelegationTokenResponse", 2);
        }
    }
}
