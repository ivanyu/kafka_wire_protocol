...
/// CreatableReplicaAssignment, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// CreateableTopicConfig, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateTopicsRequest>("CreateTopicsRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateTopicsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "CreateTopicsRequest", 1);
        }
    }
}
