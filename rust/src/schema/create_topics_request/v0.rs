...
impl CreateTopicsRequest {
    pub fn new(topics: Vec<CreatableTopic>, timeout_ms: i32) -> Self {
        Self {
            topics,
            timeout_ms,
        }
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateTopicsRequest>("CreateTopicsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateTopicsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "CreateTopicsRequest", 0);
        }
    }
}
