...
/// ShareGroupHeartbeatResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ShareGroupHeartbeatResponse>("ShareGroupHeartbeatResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ShareGroupHeartbeatResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ShareGroupHeartbeatResponse", 1);
        }
    }
}
