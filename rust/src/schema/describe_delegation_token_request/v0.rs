...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeDelegationTokenRequest>("DescribeDelegationTokenRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeDelegationTokenRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeDelegationTokenRequest", 0);
        }
    }
}
