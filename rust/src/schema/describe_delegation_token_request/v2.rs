...
/// DescribeDelegationTokenRequest, version 2.
...
/// DescribeDelegationTokenOwner, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeDelegationTokenRequest>("DescribeDelegationTokenRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeDelegationTokenRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeDelegationTokenRequest", 2);
        }
    }
}
