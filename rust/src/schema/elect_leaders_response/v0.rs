...
impl ElectLeadersResponse {
    pub fn new(throttle_time_ms: i32, replica_election_results: Vec<ReplicaElectionResult>) -> Self {
        Self {
            throttle_time_ms,
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ElectLeadersResponse>("ElectLeadersResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ElectLeadersResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ElectLeadersResponse", 0);
        }
    }
}
