...
/// ShareAcknowledgeRequest, version 0.
...
/// AcknowledgePartition, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ShareAcknowledgeRequest>("ShareAcknowledgeRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ShareAcknowledgeRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ShareAcknowledgeRequest", 0);
        }
    }
}
