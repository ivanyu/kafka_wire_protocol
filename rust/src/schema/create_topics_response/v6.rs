...
/// CreatableTopicResult, version 6.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl CreatableTopicResult {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(name: S1, error_code: i16, error_message: Option<S2>, topic_config_error_code: i16, num_partitions: i32, replication_factor: i16, configs: Option<Vec<CreatableTopicConfigs>>) -> Self {
        Self {
...
impl Readable for CreatableTopicResult {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(CreatableTopicResult {
            name, error_code, error_message, topic_config_error_code, num_partitions, replication_factor, configs, _unknown_tagged_fields
        })
    }
}
...
/// CreatableTopicConfigs, version 6.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateTopicsResponse>("CreateTopicsResponse", 6);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateTopicsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "CreateTopicsResponse", 6);
        }
    }
}
