...
/// CreateTopicsResponse, version 3.
...
/// CreatableTopicResult, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateTopicsResponse>("CreateTopicsResponse", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateTopicsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "CreateTopicsResponse", 3);
        }
    }
}
