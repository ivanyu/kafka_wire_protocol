...
/// ShareGroupDescribeResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ShareGroupDescribeResponse>("ShareGroupDescribeResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ShareGroupDescribeResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ShareGroupDescribeResponse", 1);
        }
    }
}
