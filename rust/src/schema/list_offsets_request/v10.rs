...
impl ListOffsetsRequest {
    pub fn new(replica_id: i32, isolation_level: i8, topics: Vec<ListOffsetsTopic>, timeout_ms: i32) -> Self {
        Self {
            replica_id,
            isolation_level,
            topics,
...
impl Readable for ListOffsetsRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(ListOffsetsRequest {
            replica_id, isolation_level, topics, timeout_ms, _unknown_tagged_fields
        })
    }
}
...
/// ListOffsetsPartition, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListOffsetsRequest>("ListOffsetsRequest", 10);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListOffsetsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ListOffsetsRequest", 10);
        }
    }
}
