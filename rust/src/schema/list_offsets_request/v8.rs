...
/// ListOffsetsPartition, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListOffsetsRequest>("ListOffsetsRequest", 8);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListOffsetsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ListOffsetsRequest", 8);
        }
    }
}
