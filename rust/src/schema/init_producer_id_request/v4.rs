...
/// InitProducerIdRequest, version 4.
...
impl InitProducerIdRequest {
    pub fn new<S1: AsRef<str>>(transactional_id: Option<S1>, transaction_timeout_ms: i32, producer_id: i64, producer_epoch: i16) -> Self {
        Self {
...
impl Readable for InitProducerIdRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(InitProducerIdRequest {
            transactional_id, transaction_timeout_ms, producer_id, producer_epoch, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<InitProducerIdRequest>("InitProducerIdRequest", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: InitProducerIdRequest) {
            crate::test_utils::test_java_arbitrary(&data, "InitProducerIdRequest", 4);
        }
    }
}
