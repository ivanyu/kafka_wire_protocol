...
/// InitProducerIdRequest, version 5.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<InitProducerIdRequest>("InitProducerIdRequest", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: InitProducerIdRequest) {
            crate::test_utils::test_java_arbitrary(&data, "InitProducerIdRequest", 5);
        }
    }
}
