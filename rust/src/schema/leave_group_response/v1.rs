...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<LeaveGroupResponse>("LeaveGroupResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: LeaveGroupResponse) {
            crate::test_utils::test_java_arbitrary(&data, "LeaveGroupResponse", 1);
        }
    }
}
