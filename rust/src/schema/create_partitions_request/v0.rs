...
/// CreatePartitionsRequest, version 0.
...
/// CreatePartitionsTopic, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// CreatePartitionsAssignment, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreatePartitionsRequest>("CreatePartitionsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreatePartitionsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "CreatePartitionsRequest", 0);
        }
    }
}
