...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreatePartitionsRequest>("CreatePartitionsRequest", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreatePartitionsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "CreatePartitionsRequest", 3);
        }
    }
}
