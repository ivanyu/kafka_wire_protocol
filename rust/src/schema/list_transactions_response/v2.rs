...
/// ListTransactionsResponse, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListTransactionsResponse>("ListTransactionsResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListTransactionsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ListTransactionsResponse", 2);
        }
    }
}
