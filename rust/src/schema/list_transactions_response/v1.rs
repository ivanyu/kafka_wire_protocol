...
/// ListTransactionsResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListTransactionsResponse>("ListTransactionsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListTransactionsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ListTransactionsResponse", 1);
        }
    }
}
