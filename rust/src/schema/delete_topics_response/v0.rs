...
/// DeleteTopicsResponse, version 0.
...
impl DeleteTopicsResponse {
    pub fn new(responses: Vec<DeletableTopicResult>) -> Self {
        Self {
            responses,
        }
    }
...
/// DeletableTopicResult, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteTopicsResponse>("DeleteTopicsResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteTopicsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteTopicsResponse", 0);
        }
    }
}
