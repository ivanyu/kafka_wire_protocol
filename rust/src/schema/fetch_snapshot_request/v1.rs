...
/// FetchSnapshotRequest, version 1.
...
impl PartitionSnapshot {
    pub fn new(partition: i32, current_leader_epoch: i32, snapshot_id: SnapshotId, position: i64, replica_directory_id: Uuid) -> Self {
        Self {
            partition,
...
impl Readable for PartitionSnapshot {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(PartitionSnapshot {
            partition, current_leader_epoch, snapshot_id, position, replica_directory_id, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<FetchSnapshotRequest>("FetchSnapshotRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: FetchSnapshotRequest) {
            crate::test_utils::test_java_arbitrary(&data, "FetchSnapshotRequest", 1);
        }
    }
}
