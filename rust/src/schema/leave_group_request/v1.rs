...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<LeaveGroupRequest>("LeaveGroupRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: LeaveGroupRequest) {
            crate::test_utils::test_java_arbitrary(&data, "LeaveGroupRequest", 1);
        }
    }
}
