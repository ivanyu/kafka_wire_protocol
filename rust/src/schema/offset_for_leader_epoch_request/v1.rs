...
/// OffsetForLeaderEpochRequest, version 1.
...
/// OffsetForLeaderTopic, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// OffsetForLeaderPartition, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetForLeaderEpochRequest>("OffsetForLeaderEpochRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetForLeaderEpochRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetForLeaderEpochRequest", 1);
        }
    }
}
