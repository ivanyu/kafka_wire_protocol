...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetForLeaderEpochRequest>("OffsetForLeaderEpochRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetForLeaderEpochRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetForLeaderEpochRequest", 2);
        }
    }
}
