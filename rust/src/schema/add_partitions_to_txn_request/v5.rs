...
/// AddPartitionsToTxnRequest, version 5.
...
/// AddPartitionsToTxnTransaction, version 5.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// AddPartitionsToTxnTopic, version 5.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddPartitionsToTxnRequest>("AddPartitionsToTxnRequest", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddPartitionsToTxnRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AddPartitionsToTxnRequest", 5);
        }
    }
}
