...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddPartitionsToTxnRequest>("AddPartitionsToTxnRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddPartitionsToTxnRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AddPartitionsToTxnRequest", 0);
        }
    }
}
