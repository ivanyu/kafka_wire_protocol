...
/// EndQuorumEpochResponse, version 1.
...
impl Response for EndQuorumEpochResponse { }
...
#[cfg(test)]
mod tests_end_quorum_epoch_response_new_and_default {
    use super::*;
    
    #[test]
    fn test() {
        let d = EndQuorumEpochResponse::new(
            0_i16,
            Vec::<TopicData>::new(),
            Vec::<NodeEndpoint>::new(),
        );
        assert_eq!(d, EndQuorumEpochResponse::default());
    }
}

impl Readable for EndQuorumEpochResponse {
...
impl Writable for EndQuorumEpochResponse {
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<EndQuorumEpochResponse>("EndQuorumEpochResponse", 1);
    }
    
    proptest! {
        #[test]
        fn test_serde(data: EndQuorumEpochResponse) {
    ...
    proptest! {
        #[test]
        fn test_java_arbitrary(data: EndQuorumEpochResponse) {
            crate::test_utils::test_java_arbitrary(&data, "EndQuorumEpochResponse", 1);
        }
    }
}
