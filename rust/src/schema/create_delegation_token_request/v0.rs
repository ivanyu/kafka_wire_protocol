...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateDelegationTokenRequest>("CreateDelegationTokenRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateDelegationTokenRequest) {
            crate::test_utils::test_java_arbitrary(&data, "CreateDelegationTokenRequest", 0);
        }
    }
}
