...
/// DescribeLogDirsRequest, version 4.
...
/// DescribableLogDirTopic, version 4.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeLogDirsRequest>("DescribeLogDirsRequest", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeLogDirsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeLogDirsRequest", 4);
        }
    }
}
