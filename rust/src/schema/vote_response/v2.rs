...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<VoteResponse>("VoteResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: VoteResponse) {
            crate::test_utils::test_java_arbitrary(&data, "VoteResponse", 2);
        }
    }
}
