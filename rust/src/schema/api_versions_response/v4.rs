...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ApiVersionsResponse>("ApiVersionsResponse", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ApiVersionsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ApiVersionsResponse", 4);
        }
    }
}
