...
impl ApiVersionsResponse {
    pub fn new(error_code: i16, api_keys: Vec<ApiVersion>) -> Self {
        Self {
            error_code,
            api_keys,
        }
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ApiVersionsResponse>("ApiVersionsResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ApiVersionsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ApiVersionsResponse", 0);
        }
    }
}
