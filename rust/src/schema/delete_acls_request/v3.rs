...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteAclsRequest>("DeleteAclsRequest", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteAclsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteAclsRequest", 3);
        }
    }
}
