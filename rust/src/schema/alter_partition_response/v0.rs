...
/// AlterPartitionResponse, version 0.
...
impl PartitionData {
    pub fn new(partition_index: i32, error_code: i16, leader_id: i32, leader_epoch: i32, isr: Vec<i32>, partition_epoch: i32) -> Self {
        Self {
            partition_index,
            error_code,
            leader_id,
...
impl Readable for PartitionData {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let _unknown_tagged_fields = read_tagged_fields(input, tagged_fields_callback)?;
        Ok(PartitionData {
            partition_index, error_code, leader_id, leader_epoch, isr, partition_epoch, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AlterPartitionResponse>("AlterPartitionResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AlterPartitionResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AlterPartitionResponse", 0);
        }
    }
}
