...
/// AlterPartitionResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AlterPartitionResponse>("AlterPartitionResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AlterPartitionResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AlterPartitionResponse", 1);
        }
    }
}
