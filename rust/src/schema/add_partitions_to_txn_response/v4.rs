...
/// AddPartitionsToTxnResponse, version 4.
...
/// AddPartitionsToTxnResult, version 4.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// AddPartitionsToTxnPartitionResult, version 4.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// AddPartitionsToTxnTopicResult, version 4.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddPartitionsToTxnResponse>("AddPartitionsToTxnResponse", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddPartitionsToTxnResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AddPartitionsToTxnResponse", 4);
        }
    }
}
