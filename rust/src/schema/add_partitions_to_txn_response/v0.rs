...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddPartitionsToTxnResponse>("AddPartitionsToTxnResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddPartitionsToTxnResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AddPartitionsToTxnResponse", 0);
        }
    }
}
