...
impl OffsetFetchRequest {
    pub fn new<S1: AsRef<str>>(group_id: S1, topics: Option<Vec<OffsetFetchRequestTopic>>) -> Self {
        Self {
...
impl Readable for OffsetFetchRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let topics = read_nullable_array::<OffsetFetchRequestTopic>(input, "topics", false)?;
...
/// OffsetFetchRequestTopic, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetFetchRequest>("OffsetFetchRequest", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetFetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetFetchRequest", 3);
        }
    }
}
