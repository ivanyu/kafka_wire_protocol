...
/// OffsetFetchRequestTopic, version 5.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetFetchRequest>("OffsetFetchRequest", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetFetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetFetchRequest", 5);
        }
    }
}
