...
/// OffsetFetchRequestGroup, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl OffsetFetchRequestGroup {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(group_id: S1, member_id: Option<S2>, member_epoch: i32, topics: Option<Vec<OffsetFetchRequestTopics>>) -> Self {
        Self {
...
impl Readable for OffsetFetchRequestGroup {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(OffsetFetchRequestGroup {
            group_id, member_id, member_epoch, topics, _unknown_tagged_fields
        })
    }
}
...
/// OffsetFetchRequestTopics, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl OffsetFetchRequestTopics {
    pub fn new(topic_id: Uuid, partition_indexes: Vec<i32>) -> Self {
        Self {
            topic_id,
            partition_indexes,
            _unknown_tagged_fields: vec![],
...
impl Readable for OffsetFetchRequestTopics {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(OffsetFetchRequestTopics {
            topic_id, partition_indexes, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetFetchRequest>("OffsetFetchRequest", 10);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetFetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetFetchRequest", 10);
        }
    }
}
