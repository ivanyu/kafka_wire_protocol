...
/// TxnOffsetCommitRequest, version 1.
...
/// TxnOffsetCommitRequestTopic, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// TxnOffsetCommitRequestPartition, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<TxnOffsetCommitRequest>("TxnOffsetCommitRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: TxnOffsetCommitRequest) {
            crate::test_utils::test_java_arbitrary(&data, "TxnOffsetCommitRequest", 1);
        }
    }
}
