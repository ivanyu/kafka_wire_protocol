...
/// RenewDelegationTokenRequest, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<RenewDelegationTokenRequest>("RenewDelegationTokenRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: RenewDelegationTokenRequest) {
            crate::test_utils::test_java_arbitrary(&data, "RenewDelegationTokenRequest", 0);
        }
    }
}
