...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AlterReplicaLogDirsRequest>("AlterReplicaLogDirsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AlterReplicaLogDirsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AlterReplicaLogDirsRequest", 0);
        }
    }
}
