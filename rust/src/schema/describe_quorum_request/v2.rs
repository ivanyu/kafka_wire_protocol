...
/// DescribeQuorumRequest, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeQuorumRequest>("DescribeQuorumRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeQuorumRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeQuorumRequest", 2);
        }
    }
}
