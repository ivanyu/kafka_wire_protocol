...
/// ListConfigResourcesRequest, version 1.
...
impl ListConfigResourcesRequest {
    pub fn new(resource_types: Vec<i8>) -> Self {
        Self {
            resource_types,
...
impl Readable for ListConfigResourcesRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        let resource_types = read_array::<i8>(input, "resource_types", true)?;
        ...
        Ok(ListConfigResourcesRequest {
            resource_types, _unknown_tagged_fields
        })
    }
}
...
impl Writable for ListConfigResourcesRequest {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        write_array(output, "self.resource_types", &self.resource_types, true)?;
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListConfigResourcesRequest>("ListConfigResourcesRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListConfigResourcesRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ListConfigResourcesRequest", 1);
        }
    }
}
