...
/// ControlledShutdownResponse, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ControlledShutdownResponse>("ControlledShutdownResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ControlledShutdownResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ControlledShutdownResponse", 2);
        }
    }
}
