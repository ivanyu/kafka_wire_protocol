...
/// ControlledShutdownResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ControlledShutdownResponse>("ControlledShutdownResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ControlledShutdownResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ControlledShutdownResponse", 1);
        }
    }
}
