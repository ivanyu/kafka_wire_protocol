...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ApiVersionsRequest>("ApiVersionsRequest", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ApiVersionsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ApiVersionsRequest", 4);
        }
    }
}
