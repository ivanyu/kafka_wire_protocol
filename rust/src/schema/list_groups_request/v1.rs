...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListGroupsRequest>("ListGroupsRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListGroupsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ListGroupsRequest", 1);
        }
    }
}
