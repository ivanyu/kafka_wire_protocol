...
/// AlterPartitionReassignmentsRequest, version 1.
...
impl AlterPartitionReassignmentsRequest {
    pub fn new(timeout_ms: i32, allow_replication_factor_change: bool, topics: Vec<ReassignableTopic>) -> Self {
        Self {
            timeout_ms,
...
impl Readable for AlterPartitionReassignmentsRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(AlterPartitionReassignmentsRequest {
            timeout_ms, allow_replication_factor_change, topics, _unknown_tagged_fields
        })
    }
}
...
/// ReassignablePartition, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AlterPartitionReassignmentsRequest>("AlterPartitionReassignmentsRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AlterPartitionReassignmentsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AlterPartitionReassignmentsRequest", 1);
        }
    }
}
