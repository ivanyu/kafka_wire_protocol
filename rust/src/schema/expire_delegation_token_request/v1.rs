...
/// ExpireDelegationTokenRequest, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ExpireDelegationTokenRequest>("ExpireDelegationTokenRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ExpireDelegationTokenRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ExpireDelegationTokenRequest", 1);
        }
    }
}
