...
/// ShareAcknowledgeResponse, version 1.
...
/// ShareAcknowledgeTopicResponse, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ShareAcknowledgeResponse>("ShareAcknowledgeResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ShareAcknowledgeResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ShareAcknowledgeResponse", 1);
        }
    }
}
