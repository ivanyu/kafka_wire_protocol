...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteTopicsRequest>("DeleteTopicsRequest", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteTopicsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteTopicsRequest", 4);
        }
    }
}
