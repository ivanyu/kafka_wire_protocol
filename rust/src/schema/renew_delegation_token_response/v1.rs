...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<RenewDelegationTokenResponse>("RenewDelegationTokenResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: RenewDelegationTokenResponse) {
            crate::test_utils::test_java_arbitrary(&data, "RenewDelegationTokenResponse", 1);
        }
    }
}
