...
impl ShareFetchRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(group_id: Option<S1>, member_id: Option<S2>, share_session_epoch: i32, max_wait_ms: i32, min_bytes: i32, max_bytes: i32, max_records: i32, batch_size: i32, topics: Vec<FetchTopic>, forgotten_topics_data: Vec<ForgottenTopic>) -> Self {
        Self {
...
impl Readable for ShareFetchRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let max_records = i32::read(input)?;
        let batch_size = i32::read(input)?;
        ...
        Ok(ShareFetchRequest {
            group_id, member_id, share_session_epoch, max_wait_ms, min_bytes, max_bytes, max_records, batch_size, topics, forgotten_topics_data, _unknown_tagged_fields
        })
    }
}
...
impl Writable for ShareFetchRequest {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        self.max_records.write(output)?;
        self.batch_size.write(output)?;
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ShareFetchRequest>("ShareFetchRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ShareFetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ShareFetchRequest", 1);
        }
    }
}
