...
/// DescribeLogDirsResponse, version 3.
...
/// DescribeLogDirsResult, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl Readable for DescribeLogDirsResult {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribeLogDirsResult {
            error_code, log_dir, topics, _unknown_tagged_fields
        })
    }
}
...
/// DescribeLogDirsTopic, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// DescribeLogDirsPartition, version 3.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeLogDirsResponse>("DescribeLogDirsResponse", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeLogDirsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeLogDirsResponse", 3);
        }
    }
}
