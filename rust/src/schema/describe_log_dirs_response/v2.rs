...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeLogDirsResponse>("DescribeLogDirsResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeLogDirsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeLogDirsResponse", 2);
        }
    }
}
