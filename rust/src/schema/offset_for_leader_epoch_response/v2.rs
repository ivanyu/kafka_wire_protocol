...
/// OffsetForLeaderEpochResponse, version 2.
...
/// OffsetForLeaderTopicResult, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetForLeaderEpochResponse>("OffsetForLeaderEpochResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetForLeaderEpochResponse) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetForLeaderEpochResponse", 2);
        }
    }
}
