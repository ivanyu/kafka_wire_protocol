...
/// OffsetForLeaderEpochResponse, version 0.
...
impl OffsetForLeaderEpochResponse {
    pub fn new(topics: Vec<OffsetForLeaderTopicResult>) -> Self {
        Self {
            topics,
        }
    }
...
/// OffsetForLeaderTopicResult, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl EpochEndOffset {
    pub fn new(error_code: i16, partition: i32, end_offset: i64) -> Self {
        Self {
            error_code,
            partition,
            end_offset,
...
impl Readable for EpochEndOffset {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(EpochEndOffset {
            error_code, partition, end_offset
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetForLeaderEpochResponse>("OffsetForLeaderEpochResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetForLeaderEpochResponse) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetForLeaderEpochResponse", 0);
        }
    }
}
