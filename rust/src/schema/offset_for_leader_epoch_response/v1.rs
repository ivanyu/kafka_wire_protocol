...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetForLeaderEpochResponse>("OffsetForLeaderEpochResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetForLeaderEpochResponse) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetForLeaderEpochResponse", 1);
        }
    }
}
