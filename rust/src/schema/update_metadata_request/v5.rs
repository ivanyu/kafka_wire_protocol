...
impl Readable for UpdateMetadataRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let topic_states = read_array::<UpdateMetadataTopicState>(input, "topic_states", false)?;
...
impl Readable for UpdateMetadataTopicState {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let partition_states = read_array::<UpdateMetadataPartitionState>(input, "partition_states", false)?;
...
impl Readable for UpdateMetadataPartitionState {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(UpdateMetadataPartitionState {
            partition_index, controller_epoch, leader, leader_epoch, isr, zk_version, replicas, offline_replicas
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateMetadataRequest>("UpdateMetadataRequest", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateMetadataRequest) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateMetadataRequest", 5);
        }
    }
}
