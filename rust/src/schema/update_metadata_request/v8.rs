...
/// UpdateMetadataRequest, version 8.
...
impl UpdateMetadataRequest {
    pub fn new(controller_id: i32, is_kraft_controller: bool, type_: i8, controller_epoch: i32, broker_epoch: i64, topic_states: Vec<UpdateMetadataTopicState>, live_brokers: Vec<UpdateMetadataBroker>) -> Self {
        Self {
            controller_id,
            is_kraft_controller,
            type_,
...
impl Readable for UpdateMetadataRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let is_kraft_controller = bool::read(input)?;
        let mut type_ = 0_i8;
        ...
        Ok(UpdateMetadataRequest {
            controller_id, is_kraft_controller, type_, controller_epoch, broker_epoch, topic_states, live_brokers, _unknown_tagged_fields
        })
    }
}
...
impl Writable for UpdateMetadataRequest {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        self.is_kraft_controller.write(output)?;
...
/// UpdateMetadataTopicState, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl UpdateMetadataTopicState {
    pub fn new<S1: AsRef<str>>(topic_name: S1, topic_id: Uuid, partition_states: Vec<UpdateMetadataPartitionState>) -> Self {
        Self {
...
/// UpdateMetadataBroker, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// UpdateMetadataEndpoint, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// UpdateMetadataPartitionState, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateMetadataRequest>("UpdateMetadataRequest", 8);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateMetadataRequest) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateMetadataRequest", 8);
        }
    }
}
