...
/// UpdateMetadataRequest, version 2.
...
/// UpdateMetadataBroker, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// UpdateMetadataEndpoint, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// UpdateMetadataPartitionState, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateMetadataRequest>("UpdateMetadataRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateMetadataRequest) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateMetadataRequest", 2);
        }
    }
}
