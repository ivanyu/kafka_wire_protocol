...
/// UpdateMetadataRequest, version 1.
...
/// UpdateMetadataBroker, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl UpdateMetadataBroker {
    pub fn new(id: i32, endpoints: Vec<UpdateMetadataEndpoint>) -> Self {
        Self {
            id,
            endpoints,
        }
...
/// UpdateMetadataEndpoint, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl UpdateMetadataEndpoint {
    pub fn new<S1: AsRef<str>>(port: i32, host: S1, security_protocol: i16) -> Self {
        Self {
            port,
...
/// UpdateMetadataPartitionState, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateMetadataRequest>("UpdateMetadataRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateMetadataRequest) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateMetadataRequest", 1);
        }
    }
}
