...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<IncrementalAlterConfigsResponse>("IncrementalAlterConfigsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: IncrementalAlterConfigsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "IncrementalAlterConfigsResponse", 1);
        }
    }
}
