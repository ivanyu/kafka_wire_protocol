...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeAclsRequest>("DescribeAclsRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeAclsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeAclsRequest", 2);
        }
    }
}
