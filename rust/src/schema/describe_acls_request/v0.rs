...
impl DescribeAclsRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>, S3: AsRef<str>>(resource_type_filter: i8, resource_name_filter: Option<S1>, principal_filter: Option<S2>, host_filter: Option<S3>, operation: i8, permission_type: i8) -> Self {
        Self {
...
impl Readable for DescribeAclsRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribeAclsRequest {
            resource_type_filter, resource_name_filter, principal_filter, host_filter, operation, permission_type
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeAclsRequest>("DescribeAclsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeAclsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeAclsRequest", 0);
        }
    }
}
