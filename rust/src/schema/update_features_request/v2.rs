...
/// UpdateFeaturesRequest, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateFeaturesRequest>("UpdateFeaturesRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateFeaturesRequest) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateFeaturesRequest", 2);
        }
    }
}
