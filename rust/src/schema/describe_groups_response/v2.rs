...
/// DescribeGroupsResponse, version 2.
...
/// DescribedGroupMember, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeGroupsResponse>("DescribeGroupsResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeGroupsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeGroupsResponse", 2);
        }
    }
}
