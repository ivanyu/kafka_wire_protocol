...
/// DescribeGroupsResponse, version 6.
...
impl DescribedGroup {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>, S3: AsRef<str>, S4: AsRef<str>, S5: AsRef<str>>(error_code: i16, error_message: Option<S1>, group_id: S2, group_state: S3, protocol_type: S4, protocol_data: S5, members: Vec<DescribedGroupMember>, authorized_operations: i32) -> Self {
        Self {
            error_code,
...
impl Readable for DescribedGroup {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let _unknown_tagged_fields = read_tagged_fields(input, tagged_fields_callback)?;
        Ok(DescribedGroup {
            error_code, error_message, group_id, group_state, protocol_type, protocol_data, members, authorized_operations, _unknown_tagged_fields
        })
    }
}
...
/// DescribedGroupMember, version 6.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeGroupsResponse>("DescribeGroupsResponse", 6);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeGroupsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeGroupsResponse", 6);
        }
    }
}
