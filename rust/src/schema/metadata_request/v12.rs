...
impl MetadataRequest {
    pub fn new(topics: Option<Vec<MetadataRequestTopic>>, allow_auto_topic_creation: bool, include_topic_authorized_operations: bool) -> Self {
        Self {
            topics,
...
/// MetadataRequestTopic, version 12.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<MetadataRequest>("MetadataRequest", 12);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: MetadataRequest) {
            crate::test_utils::test_java_arbitrary(&data, "MetadataRequest", 12);
        }
    }
}
