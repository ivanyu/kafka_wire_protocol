...
/// ListTransactionsRequest, version 2.
...
impl ListTransactionsRequest {
    pub fn new<S1: AsRef<str>>(state_filters: Vec<String>, producer_id_filters: Vec<i64>, duration_filter: i64, transactional_id_pattern: Option<S1>) -> Self {
        Self {
            state_filters,
            producer_id_filters,
            duration_filter,
            transactional_id_pattern: transactional_id_pattern.map(|s| s.as_ref().to_string()),
...
impl Readable for ListTransactionsRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let transactional_id_pattern = Option::<String>::read_ext(input, "transactional_id_pattern", true)?;
        ...
        Ok(ListTransactionsRequest {
            state_filters, producer_id_filters, duration_filter, transactional_id_pattern, _unknown_tagged_fields
        })
    }
}
...
impl Writable for ListTransactionsRequest {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        self.transactional_id_pattern.write_ext(output, "self.transactional_id_pattern", true)?;
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListTransactionsRequest>("ListTransactionsRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListTransactionsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ListTransactionsRequest", 2);
        }
    }
}
