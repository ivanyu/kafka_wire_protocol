...
/// ListTransactionsRequest, version 0.
...
impl ListTransactionsRequest {
    pub fn new(state_filters: Vec<String>, producer_id_filters: Vec<i64>) -> Self {
        Self {
            state_filters,
            producer_id_filters,
...
impl Readable for ListTransactionsRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(ListTransactionsRequest {
            state_filters, producer_id_filters, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListTransactionsRequest>("ListTransactionsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListTransactionsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ListTransactionsRequest", 0);
        }
    }
}
