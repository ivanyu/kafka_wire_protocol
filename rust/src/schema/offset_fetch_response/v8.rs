...
/// OffsetFetchResponseGroup, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// OffsetFetchResponseTopics, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl OffsetFetchResponseTopics {
    pub fn new<S1: AsRef<str>>(name: S1, partitions: Vec<OffsetFetchResponsePartitions>) -> Self {
        Self {
...
/// OffsetFetchResponsePartitions, version 8.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetFetchResponse>("OffsetFetchResponse", 8);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetFetchResponse) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetFetchResponse", 8);
        }
    }
}
