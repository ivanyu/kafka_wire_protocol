...
impl Readable for OffsetFetchResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(OffsetFetchResponse {
            throttle_time_ms, topics, error_code
        })
    }
}
...
impl ApiMessage for OffsetFetchResponseTopic {
    fn api_key(&self) -> i16 {
        9
    }
...
impl Response for OffsetFetchResponseTopic { }
...
impl ApiMessage for OffsetFetchResponsePartition {
    fn api_key(&self) -> i16 {
        9
    }
...
impl Response for OffsetFetchResponsePartition { }
...
impl Readable for OffsetFetchResponsePartition {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(OffsetFetchResponsePartition {
            partition_index, committed_offset, committed_leader_epoch, metadata, error_code
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetFetchResponse>("OffsetFetchResponse", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetFetchResponse) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetFetchResponse", 5);
        }
    }
}
