...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateAclsRequest>("CreateAclsRequest", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateAclsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "CreateAclsRequest", 3);
        }
    }
}
