...
/// ConsumerGroupDescribeRequest, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ConsumerGroupDescribeRequest>("ConsumerGroupDescribeRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ConsumerGroupDescribeRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ConsumerGroupDescribeRequest", 1);
        }
    }
}
