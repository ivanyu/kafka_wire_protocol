...
/// AddOffsetsToTxnResponse, version 4.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddOffsetsToTxnResponse>("AddOffsetsToTxnResponse", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddOffsetsToTxnResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AddOffsetsToTxnResponse", 4);
        }
    }
}
