...
/// AddOffsetsToTxnResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AddOffsetsToTxnResponse>("AddOffsetsToTxnResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AddOffsetsToTxnResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AddOffsetsToTxnResponse", 1);
        }
    }
}
