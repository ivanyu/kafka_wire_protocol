...
/// AlterPartitionReassignmentsResponse, version 1.
...
impl AlterPartitionReassignmentsResponse {
    pub fn new<S1: AsRef<str>>(throttle_time_ms: i32, allow_replication_factor_change: bool, error_code: i16, error_message: Option<S1>, responses: Vec<ReassignableTopicResponse>) -> Self {
        Self {
            throttle_time_ms,
...
impl Readable for AlterPartitionReassignmentsResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let allow_replication_factor_change = bool::read(input)?;
        ...
        Ok(AlterPartitionReassignmentsResponse {
            throttle_time_ms, allow_replication_factor_change, error_code, error_message, responses, _unknown_tagged_fields
        })
    }
}
...
impl Writable for AlterPartitionReassignmentsResponse {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        self.allow_replication_factor_change.write(output)?;
...
/// ReassignableTopicResponse, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// ReassignablePartitionResponse, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AlterPartitionReassignmentsResponse>("AlterPartitionReassignmentsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AlterPartitionReassignmentsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "AlterPartitionReassignmentsResponse", 1);
        }
    }
}
