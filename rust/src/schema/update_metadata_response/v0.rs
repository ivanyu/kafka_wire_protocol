...
/// UpdateMetadataResponse, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateMetadataResponse>("UpdateMetadataResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateMetadataResponse) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateMetadataResponse", 0);
        }
    }
}
