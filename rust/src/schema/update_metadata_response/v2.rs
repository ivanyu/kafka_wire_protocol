...
/// UpdateMetadataResponse, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateMetadataResponse>("UpdateMetadataResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateMetadataResponse) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateMetadataResponse", 2);
        }
    }
}
