...
/// UpdateMetadataResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<UpdateMetadataResponse>("UpdateMetadataResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: UpdateMetadataResponse) {
            crate::test_utils::test_java_arbitrary(&data, "UpdateMetadataResponse", 1);
        }
    }
}
