...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<HeartbeatResponse>("HeartbeatResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: HeartbeatResponse) {
            crate::test_utils::test_java_arbitrary(&data, "HeartbeatResponse", 2);
        }
    }
}
