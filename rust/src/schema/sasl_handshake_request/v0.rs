...
/// SaslHandshakeRequest, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<SaslHandshakeRequest>("SaslHandshakeRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: SaslHandshakeRequest) {
            crate::test_utils::test_java_arbitrary(&data, "SaslHandshakeRequest", 0);
        }
    }
}
