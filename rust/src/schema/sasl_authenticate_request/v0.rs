...
/// SaslAuthenticateRequest, version 0.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<SaslAuthenticateRequest>("SaslAuthenticateRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: SaslAuthenticateRequest) {
            crate::test_utils::test_java_arbitrary(&data, "SaslAuthenticateRequest", 0);
        }
    }
}
