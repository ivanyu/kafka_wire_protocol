...
impl DescribeAclsResource {
    pub fn new<S1: AsRef<str>>(resource_type: i8, resource_name: S1, acls: Vec<AclDescription>) -> Self {
        Self {
            resource_type,
...
impl Readable for DescribeAclsResource {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribeAclsResource {
            resource_type, resource_name, acls
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeAclsResponse>("DescribeAclsResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeAclsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeAclsResponse", 0);
        }
    }
}
