...
/// ConsumerGroupHeartbeatResponse, version 1.
...
impl Response for ConsumerGroupHeartbeatResponse { }
...
#[cfg(test)]
mod tests_consumer_group_heartbeat_response_new_and_default {
    use super::*;
    
    #[test]
    fn test() {
        let d = ConsumerGroupHeartbeatResponse::new(
            0_i32,
            0_i16,
            None::<String>,
            None::<String>,
        ...
        assert_eq!(d, ConsumerGroupHeartbeatResponse::default());
    }
}

impl Readable for ConsumerGroupHeartbeatResponse {
...
impl Writable for ConsumerGroupHeartbeatResponse {
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ConsumerGroupHeartbeatResponse>("ConsumerGroupHeartbeatResponse", 1);
    }
    
    proptest! {
        #[test]
        fn test_serde(data: ConsumerGroupHeartbeatResponse) {
    ...
    proptest! {
        #[test]
        fn test_java_arbitrary(data: ConsumerGroupHeartbeatResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ConsumerGroupHeartbeatResponse", 1);
        }
    }
}
