...
/// CreatePartitionsResponse, version 2.
...
/// CreatePartitionsTopicResult, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreatePartitionsResponse>("CreatePartitionsResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreatePartitionsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "CreatePartitionsResponse", 2);
        }
    }
}
