...
/// CreatePartitionsResponse, version 1.
...
/// CreatePartitionsTopicResult, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreatePartitionsResponse>("CreatePartitionsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreatePartitionsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "CreatePartitionsResponse", 1);
        }
    }
}
