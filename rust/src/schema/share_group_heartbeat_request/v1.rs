...
/// ShareGroupHeartbeatRequest, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ShareGroupHeartbeatRequest>("ShareGroupHeartbeatRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ShareGroupHeartbeatRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ShareGroupHeartbeatRequest", 1);
        }
    }
}
