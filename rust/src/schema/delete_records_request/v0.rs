...
/// DeleteRecordsRequest, version 0.
...
/// DeleteRecordsPartition, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteRecordsRequest>("DeleteRecordsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteRecordsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteRecordsRequest", 0);
        }
    }
}
