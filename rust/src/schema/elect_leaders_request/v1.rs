...
impl Readable for ElectLeadersRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(ElectLeadersRequest {
            election_type, topic_partitions, timeout_ms
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ElectLeadersRequest>("ElectLeadersRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ElectLeadersRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ElectLeadersRequest", 1);
        }
    }
}
