...
/// LeaderAndIsrLiveLeader, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// LeaderAndIsrPartitionState, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl LeaderAndIsrPartitionState {
    pub fn new<S1: AsRef<str>>(topic_name: S1, partition_index: i32, controller_epoch: i32, leader: i32, leader_epoch: i32, isr: Vec<i32>, partition_epoch: i32, replicas: Vec<i32>, is_new: bool) -> Self {
        Self {
...
impl Readable for LeaderAndIsrPartitionState {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(LeaderAndIsrPartitionState {
            topic_name, partition_index, controller_epoch, leader, leader_epoch, isr, partition_epoch, replicas, is_new
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<LeaderAndIsrRequest>("LeaderAndIsrRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: LeaderAndIsrRequest) {
            crate::test_utils::test_java_arbitrary(&data, "LeaderAndIsrRequest", 1);
        }
    }
}
