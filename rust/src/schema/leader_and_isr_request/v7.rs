...
impl LeaderAndIsrRequest {
    pub fn new(controller_id: i32, is_kraft_controller: bool, controller_epoch: i32, broker_epoch: i64, type_: i8, topic_states: Vec<LeaderAndIsrTopicState>, live_leaders: Vec<LeaderAndIsrLiveLeader>) -> Self {
        Self {
            controller_id,
            is_kraft_controller,
            controller_epoch,
...
impl Readable for LeaderAndIsrRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(LeaderAndIsrRequest {
            controller_id, is_kraft_controller, controller_epoch, broker_epoch, type_, topic_states, live_leaders, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<LeaderAndIsrRequest>("LeaderAndIsrRequest", 7);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: LeaderAndIsrRequest) {
            crate::test_utils::test_java_arbitrary(&data, "LeaderAndIsrRequest", 7);
        }
    }
}
