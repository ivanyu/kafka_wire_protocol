...
/// InitProducerIdResponse, version 2.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<InitProducerIdResponse>("InitProducerIdResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: InitProducerIdResponse) {
            crate::test_utils::test_java_arbitrary(&data, "InitProducerIdResponse", 2);
        }
    }
}
