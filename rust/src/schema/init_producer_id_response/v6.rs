...
/// InitProducerIdResponse, version 6.
...
impl Default for InitProducerIdResponse {
    fn default() -> Self {
        InitProducerIdResponse {
            ...
            ongoing_txn_producer_id: -1_i64,
            ongoing_txn_producer_epoch: -1_i16,
...
impl InitProducerIdResponse {
    pub fn new(throttle_time_ms: i32, error_code: i16, producer_id: i64, producer_epoch: i16, ongoing_txn_producer_id: i64, ongoing_txn_producer_epoch: i16) -> Self {
        Self {
            throttle_time_ms,
            error_code,
            producer_id,
...
impl Readable for InitProducerIdResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let ongoing_txn_producer_id = i64::read(input)?;
        let ongoing_txn_producer_epoch = i16::read(input)?;
        ...
        Ok(InitProducerIdResponse {
            throttle_time_ms, error_code, producer_id, producer_epoch, ongoing_txn_producer_id, ongoing_txn_producer_epoch, _unknown_tagged_fields
        })
    }
}
...
impl Writable for InitProducerIdResponse {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        self.ongoing_txn_producer_id.write(output)?;
        self.ongoing_txn_producer_epoch.write(output)?;
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<InitProducerIdResponse>("InitProducerIdResponse", 6);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: InitProducerIdResponse) {
            crate::test_utils::test_java_arbitrary(&data, "InitProducerIdResponse", 6);
        }
    }
}
