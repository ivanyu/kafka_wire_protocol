...
impl MetadataResponse {
    pub fn new<S1: AsRef<str>>(throttle_time_ms: i32, brokers: Vec<MetadataResponseBroker>, cluster_id: Option<S1>, controller_id: i32, topics: Vec<MetadataResponseTopic>, cluster_authorized_operations: i32) -> Self {
        Self {
            throttle_time_ms,
            brokers,
...
impl Readable for MetadataResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(MetadataResponse {
            throttle_time_ms, brokers, cluster_id, controller_id, topics, cluster_authorized_operations, _unknown_tagged_fields
        })
    }
}
...
/// MetadataResponseBroker, version 9.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// MetadataResponseTopic, version 9.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl MetadataResponseTopic {
    pub fn new<S1: AsRef<str>>(error_code: i16, name: S1, is_internal: bool, partitions: Vec<MetadataResponsePartition>, topic_authorized_operations: i32) -> Self {
        Self {
            error_code,
...
impl Readable for MetadataResponseTopic {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(MetadataResponseTopic {
            error_code, name, is_internal, partitions, topic_authorized_operations, _unknown_tagged_fields
        })
    }
}
...
/// MetadataResponsePartition, version 9.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<MetadataResponse>("MetadataResponse", 9);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: MetadataResponse) {
            crate::test_utils::test_java_arbitrary(&data, "MetadataResponse", 9);
        }
    }
}
