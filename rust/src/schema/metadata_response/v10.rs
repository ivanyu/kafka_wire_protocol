...
/// MetadataResponseBroker, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// MetadataResponseTopic, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl MetadataResponseTopic {
    pub fn new<S1: AsRef<str>>(error_code: i16, name: S1, topic_id: Uuid, is_internal: bool, partitions: Vec<MetadataResponsePartition>, topic_authorized_operations: i32) -> Self {
        Self {
            error_code,
...
/// MetadataResponsePartition, version 10.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<MetadataResponse>("MetadataResponse", 10);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: MetadataResponse) {
            crate::test_utils::test_java_arbitrary(&data, "MetadataResponse", 10);
        }
    }
}
