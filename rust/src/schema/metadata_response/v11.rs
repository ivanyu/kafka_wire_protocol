...
impl Readable for MetadataResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(MetadataResponse {
            throttle_time_ms, brokers, cluster_id, controller_id, topics, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<MetadataResponse>("MetadataResponse", 11);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: MetadataResponse) {
            crate::test_utils::test_java_arbitrary(&data, "MetadataResponse", 11);
        }
    }
}
