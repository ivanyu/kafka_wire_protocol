...
impl DescribeClusterResponse {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(throttle_time_ms: i32, error_code: i16, error_message: Option<S1>, cluster_id: S2, controller_id: i32, brokers: Vec<DescribeClusterBroker>, cluster_authorized_operations: i32) -> Self {
        Self {
            throttle_time_ms,
            error_code,
...
impl Readable for DescribeClusterResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribeClusterResponse {
            throttle_time_ms, error_code, error_message, cluster_id, controller_id, brokers, cluster_authorized_operations, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeClusterResponse>("DescribeClusterResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeClusterResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeClusterResponse", 0);
        }
    }
}
