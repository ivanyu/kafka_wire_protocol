...
/// DescribeClusterBroker, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl DescribeClusterBroker {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(broker_id: i32, host: S1, port: i32, rack: Option<S2>, is_fenced: bool) -> Self {
        Self {
            broker_id,
...
impl Readable for DescribeClusterBroker {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribeClusterBroker {
            broker_id, host, port, rack, is_fenced, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeClusterResponse>("DescribeClusterResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeClusterResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeClusterResponse", 2);
        }
    }
}
