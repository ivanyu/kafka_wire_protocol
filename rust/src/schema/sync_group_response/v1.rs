...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<SyncGroupResponse>("SyncGroupResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: SyncGroupResponse) {
            crate::test_utils::test_java_arbitrary(&data, "SyncGroupResponse", 1);
        }
    }
}
