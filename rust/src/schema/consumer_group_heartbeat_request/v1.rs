...
/// ConsumerGroupHeartbeatRequest, version 1.
...
impl ConsumerGroupHeartbeatRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>, S3: AsRef<str>, S4: AsRef<str>, S5: AsRef<str>, S6: AsRef<str>>(group_id: S1, member_id: S2, member_epoch: i32, instance_id: Option<S3>, rack_id: Option<S4>, rebalance_timeout_ms: i32, subscribed_topic_names: Option<Vec<String>>, subscribed_topic_regex: Option<S5>, server_assignor: Option<S6>, topic_partitions: Option<Vec<TopicPartitions>>) -> Self {
        Self {
...
impl Readable for ConsumerGroupHeartbeatRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(ConsumerGroupHeartbeatRequest {
            group_id, member_id, member_epoch, instance_id, rack_id, rebalance_timeout_ms, subscribed_topic_names, subscribed_topic_regex, server_assignor, topic_partitions, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ConsumerGroupHeartbeatRequest>("ConsumerGroupHeartbeatRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ConsumerGroupHeartbeatRequest) {
            crate::test_utils::test_java_arbitrary(&data, "ConsumerGroupHeartbeatRequest", 1);
        }
    }
}
