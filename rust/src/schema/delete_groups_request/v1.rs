...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DeleteGroupsRequest>("DeleteGroupsRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DeleteGroupsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DeleteGroupsRequest", 1);
        }
    }
}
