...
/// JoinGroupResponseMember, version 4.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<JoinGroupResponse>("JoinGroupResponse", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: JoinGroupResponse) {
            crate::test_utils::test_java_arbitrary(&data, "JoinGroupResponse", 4);
        }
    }
}
