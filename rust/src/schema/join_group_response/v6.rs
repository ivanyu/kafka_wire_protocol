...
impl JoinGroupResponse {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>, S3: AsRef<str>>(throttle_time_ms: i32, error_code: i16, generation_id: i32, protocol_name: S1, leader: S2, member_id: S3, members: Vec<JoinGroupResponseMember>) -> Self {
        Self {
            throttle_time_ms,
            error_code,
            generation_id,
...
impl Readable for JoinGroupResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let protocol_name = String::read_ext(input, "protocol_name", true)?;
        ...
        Ok(JoinGroupResponse {
            throttle_time_ms, error_code, generation_id, protocol_name, leader, member_id, members, _unknown_tagged_fields
        })
    }
}
...
/// JoinGroupResponseMember, version 6.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<JoinGroupResponse>("JoinGroupResponse", 6);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: JoinGroupResponse) {
            crate::test_utils::test_java_arbitrary(&data, "JoinGroupResponse", 6);
        }
    }
}
