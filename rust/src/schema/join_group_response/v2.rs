...
/// JoinGroupResponseMember, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<JoinGroupResponse>("JoinGroupResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: JoinGroupResponse) {
            crate::test_utils::test_java_arbitrary(&data, "JoinGroupResponse", 2);
        }
    }
}
