...
/// BrokerHeartbeatResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<BrokerHeartbeatResponse>("BrokerHeartbeatResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: BrokerHeartbeatResponse) {
            crate::test_utils::test_java_arbitrary(&data, "BrokerHeartbeatResponse", 1);
        }
    }
}
