...
/// LeaderAndIsrResponse, version 0.
...
/// LeaderAndIsrPartitionError, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<LeaderAndIsrResponse>("LeaderAndIsrResponse", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: LeaderAndIsrResponse) {
            crate::test_utils::test_java_arbitrary(&data, "LeaderAndIsrResponse", 0);
        }
    }
}
