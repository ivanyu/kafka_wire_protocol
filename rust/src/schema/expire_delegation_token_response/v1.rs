...
/// ExpireDelegationTokenResponse, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ExpireDelegationTokenResponse>("ExpireDelegationTokenResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ExpireDelegationTokenResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ExpireDelegationTokenResponse", 1);
        }
    }
}
