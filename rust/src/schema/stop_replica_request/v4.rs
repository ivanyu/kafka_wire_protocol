...
impl StopReplicaRequest {
    pub fn new(controller_id: i32, is_kraft_controller: bool, controller_epoch: i32, broker_epoch: i64, topic_states: Vec<StopReplicaTopicState>) -> Self {
        Self {
            controller_id,
            is_kraft_controller,
            controller_epoch,
...
impl Readable for StopReplicaRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(StopReplicaRequest {
            controller_id, is_kraft_controller, controller_epoch, broker_epoch, topic_states, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<StopReplicaRequest>("StopReplicaRequest", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: StopReplicaRequest) {
            crate::test_utils::test_java_arbitrary(&data, "StopReplicaRequest", 4);
        }
    }
}
