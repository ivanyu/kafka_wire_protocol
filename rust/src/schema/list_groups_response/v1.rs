...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListGroupsResponse>("ListGroupsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListGroupsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ListGroupsResponse", 1);
        }
    }
}
