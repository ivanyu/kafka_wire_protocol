...
impl ListedGroup {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>, S3: AsRef<str>>(group_id: S1, protocol_type: S2, group_state: S3) -> Self {
        Self {
...
impl Readable for ListedGroup {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let _unknown_tagged_fields = read_tagged_fields(input, tagged_fields_callback)?;
        Ok(ListedGroup {
            group_id, protocol_type, group_state, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ListGroupsResponse>("ListGroupsResponse", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ListGroupsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ListGroupsResponse", 4);
        }
    }
}
