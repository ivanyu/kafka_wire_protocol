...
impl ApiMessage for AclCreationResult {
    fn api_key(&self) -> i16 {
        30
    }
...
impl Response for AclCreationResult { }
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<CreateAclsResponse>("CreateAclsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: CreateAclsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "CreateAclsResponse", 1);
        }
    }
}
