...
impl JoinGroupRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>, S3: AsRef<str>>(group_id: S1, session_timeout_ms: i32, member_id: S2, protocol_type: S3, protocols: Vec<JoinGroupRequestProtocol>) -> Self {
        Self {
...
impl Readable for JoinGroupRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(JoinGroupRequest {
            group_id, session_timeout_ms, member_id, protocol_type, protocols
        })
    }
}
...
/// JoinGroupRequestProtocol, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<JoinGroupRequest>("JoinGroupRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: JoinGroupRequest) {
            crate::test_utils::test_java_arbitrary(&data, "JoinGroupRequest", 0);
        }
    }
}
