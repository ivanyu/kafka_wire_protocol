...
/// JoinGroupRequestProtocol, version 7.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<JoinGroupRequest>("JoinGroupRequest", 7);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: JoinGroupRequest) {
            crate::test_utils::test_java_arbitrary(&data, "JoinGroupRequest", 7);
        }
    }
}
