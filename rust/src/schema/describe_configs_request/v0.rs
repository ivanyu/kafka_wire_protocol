...
impl DescribeConfigsRequest {
    pub fn new(resources: Vec<DescribeConfigsResource>) -> Self {
        Self {
            resources,
        }
    }
...
/// DescribeConfigsResource, version 0.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeConfigsRequest>("DescribeConfigsRequest", 0);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeConfigsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeConfigsRequest", 0);
        }
    }
}
