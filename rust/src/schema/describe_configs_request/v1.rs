...
/// DescribeConfigsRequest, version 1.
...
/// DescribeConfigsResource, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeConfigsRequest>("DescribeConfigsRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeConfigsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeConfigsRequest", 1);
        }
    }
}
