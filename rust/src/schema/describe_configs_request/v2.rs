...
/// DescribeConfigsRequest, version 2.
...
impl DescribeConfigsRequest {
    pub fn new(resources: Vec<DescribeConfigsResource>, include_synonyms: bool) -> Self {
        Self {
            resources,
            include_synonyms,
        }
...
/// DescribeConfigsResource, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeConfigsRequest>("DescribeConfigsRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeConfigsRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeConfigsRequest", 2);
        }
    }
}
