...
/// TopicProduceResponse, version 13.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl TopicProduceResponse {
    pub fn new(topic_id: Uuid, partition_responses: Vec<PartitionProduceResponse>) -> Self {
        Self {
            topic_id,
            partition_responses,
            _unknown_tagged_fields: vec![],
...
impl Readable for TopicProduceResponse {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(TopicProduceResponse {
            topic_id, partition_responses, _unknown_tagged_fields
        })
    }
}
...
/// PartitionProduceResponse, version 13.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// BatchIndexAndErrorMessage, version 13.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<ProduceResponse>("ProduceResponse", 13);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: ProduceResponse) {
            crate::test_utils::test_java_arbitrary(&data, "ProduceResponse", 13);
        }
    }
}
