...
/// TxnOffsetCommitResponse, version 1.
...
/// TxnOffsetCommitResponseTopic, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// TxnOffsetCommitResponsePartition, version 1.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<TxnOffsetCommitResponse>("TxnOffsetCommitResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: TxnOffsetCommitResponse) {
            crate::test_utils::test_java_arbitrary(&data, "TxnOffsetCommitResponse", 1);
        }
    }
}
