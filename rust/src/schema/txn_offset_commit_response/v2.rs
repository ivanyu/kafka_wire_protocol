...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<TxnOffsetCommitResponse>("TxnOffsetCommitResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: TxnOffsetCommitResponse) {
            crate::test_utils::test_java_arbitrary(&data, "TxnOffsetCommitResponse", 2);
        }
    }
}
