...
/// TxnOffsetCommitResponse, version 4.
...
/// TxnOffsetCommitResponseTopic, version 4.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// TxnOffsetCommitResponsePartition, version 4.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<TxnOffsetCommitResponse>("TxnOffsetCommitResponse", 4);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: TxnOffsetCommitResponse) {
            crate::test_utils::test_java_arbitrary(&data, "TxnOffsetCommitResponse", 4);
        }
    }
}
