...
impl FetchRequest {
    pub fn new<S1: AsRef<str>>(replica_id: i32, max_wait_ms: i32, min_bytes: i32, max_bytes: i32, isolation_level: i8, session_id: i32, session_epoch: i32, topics: Vec<FetchTopic>, forgotten_topics_data: Vec<ForgottenTopic>, rack_id: S1) -> Self {
        Self {
            replica_id,
            max_wait_ms,
            min_bytes,
...
impl Readable for FetchRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let rack_id = String::read_ext(input, "rack_id", false)?;
        Ok(FetchRequest {
            replica_id, max_wait_ms, min_bytes, max_bytes, isolation_level, session_id, session_epoch, topics, forgotten_topics_data, rack_id
        })
    }
}
...
impl Writable for FetchRequest {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        self.rack_id.write_ext(output, "self.rack_id", false)?;
        Ok(())
    }
}
...
impl FetchPartition {
    pub fn new(partition: i32, current_leader_epoch: i32, fetch_offset: i64, log_start_offset: i64, partition_max_bytes: i32) -> Self {
        Self {
            partition,
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<FetchRequest>("FetchRequest", 11);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: FetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "FetchRequest", 11);
        }
    }
}
