...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<FetchRequest>("FetchRequest", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: FetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "FetchRequest", 2);
        }
    }
}
