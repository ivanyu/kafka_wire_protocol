...
impl FetchRequest {
    pub fn new(replica_id: i32, max_wait_ms: i32, min_bytes: i32, max_bytes: i32, isolation_level: i8, topics: Vec<FetchTopic>) -> Self {
        Self {
            replica_id,
            max_wait_ms,
            min_bytes,
...
impl Readable for FetchRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(FetchRequest {
            replica_id, max_wait_ms, min_bytes, max_bytes, isolation_level, topics
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<FetchRequest>("FetchRequest", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: FetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "FetchRequest", 5);
        }
    }
}
