...
impl FetchRequest {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(cluster_id: Option<S1>, replica_state: ReplicaState, max_wait_ms: i32, min_bytes: i32, max_bytes: i32, isolation_level: i8, session_id: i32, session_epoch: i32, topics: Vec<FetchTopic>, forgotten_topics_data: Vec<ForgottenTopic>, rack_id: S2) -> Self {
        Self {
    ...
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let tagged_fields_callback = |tag: i32, tag_data: &[u8]| {
            match tag {
                ...
                1 => {
                    let mut cur = Cursor::new(tag_data);
                    replica_state = ReplicaState::read(&mut cur)?;
                    Ok(true)
                },
                _ => Ok(false)
            }
        ...
        Ok(FetchRequest {
            cluster_id, replica_state, max_wait_ms, min_bytes, max_bytes, isolation_level, session_id, session_epoch, topics, forgotten_topics_data, rack_id, _unknown_tagged_fields
        })
    }
}
...
impl Writable for FetchRequest {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        if self.replica_state != ReplicaState::default() {
            let mut cur = Cursor::new(Vec::<u8>::new());
            self.replica_state.write(&mut cur)?;
...
impl ReplicaState {
    pub fn new(replica_id: i32, replica_epoch: i64) -> Self {
        Self {
            replica_id,
            replica_epoch,
            _unknown_tagged_fields: vec![],
...
impl Readable for ReplicaState {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let replica_epoch = i64::read(input)?;
        ...
        let _unknown_tagged_fields = read_tagged_fields(input, tagged_fields_callback)?;
        Ok(ReplicaState {
            replica_id, replica_epoch, _unknown_tagged_fields
        })
    }
}
...
impl Default for FetchPartition {
    fn default() -> Self {
        FetchPartition {
            ...
            high_watermark: 9223372036854775807_i64,
            _unknown_tagged_fields: Vec::new(),
        }
    }
}
...
impl FetchPartition {
    pub fn new(partition: i32, current_leader_epoch: i32, fetch_offset: i64, last_fetched_epoch: i32, log_start_offset: i64, partition_max_bytes: i32, replica_directory_id: Uuid, high_watermark: i64) -> Self {
        Self {
            partition,
...
impl Readable for FetchPartition {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        let mut high_watermark = 9223372036854775807_i64;
        let tagged_fields_callback = |tag: i32, tag_data: &[u8]| {
            match tag {
                0 => {
                    let mut cur = Cursor::new(tag_data);
                    replica_directory_id = Uuid::read(&mut cur)?;
                    Ok(true)
                },
                1 => {
                    let mut cur = Cursor::new(tag_data);
                    high_watermark = i64::read(&mut cur)?;
                    Ok(true)
                },
                _ => Ok(false)
            }
        ...
        let _unknown_tagged_fields = read_tagged_fields(input, tagged_fields_callback)?;
        Ok(FetchPartition {
            partition, current_leader_epoch, fetch_offset, last_fetched_epoch, log_start_offset, partition_max_bytes, replica_directory_id, high_watermark, _unknown_tagged_fields
        })
    }
}
...
impl Writable for FetchPartition {
    fn write(&self, #[allow(unused)] output: &mut impl Write) -> Result<()> {
        ...
        if self.replica_directory_id != Uuid::nil() {
            let mut cur = Cursor::new(Vec::<u8>::new());
            self.replica_directory_id.write(&mut cur)?;
            known_tagged_fields.push(RawTaggedField { tag: 0, data: cur.into_inner() });
        }
        if self.high_watermark != 9223372036854775807_i64 {
            let mut cur = Cursor::new(Vec::<u8>::new());
            self.high_watermark.write(&mut cur)?;
            known_tagged_fields.push(RawTaggedField { tag: 1, data: cur.into_inner() });
        }
        write_tagged_fields(output, &known_tagged_fields, &self._unknown_tagged_fields)?;
        Ok(())
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<FetchRequest>("FetchRequest", 18);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: FetchRequest) {
            crate::test_utils::test_java_arbitrary(&data, "FetchRequest", 18);
        }
    }
}
