...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<HeartbeatRequest>("HeartbeatRequest", 3);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: HeartbeatRequest) {
            crate::test_utils::test_java_arbitrary(&data, "HeartbeatRequest", 3);
        }
    }
}
