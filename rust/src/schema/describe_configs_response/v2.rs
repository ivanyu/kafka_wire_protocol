...
/// DescribeConfigsResponse, version 2.
...
/// DescribeConfigsResult, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// DescribeConfigsResourceResult, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
impl DescribeConfigsResourceResult {
    pub fn new<S1: AsRef<str>, S2: AsRef<str>>(name: S1, value: Option<S2>, read_only: bool, config_source: i8, is_sensitive: bool, synonyms: Vec<DescribeConfigsSynonym>) -> Self {
        Self {
...
impl Readable for DescribeConfigsResourceResult {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribeConfigsResourceResult {
            name, value, read_only, config_source, is_sensitive, synonyms
        })
    }
}
...
/// DescribeConfigsSynonym, version 2.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeConfigsResponse>("DescribeConfigsResponse", 2);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeConfigsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeConfigsResponse", 2);
        }
    }
}
