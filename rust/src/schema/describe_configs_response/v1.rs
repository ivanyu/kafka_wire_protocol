...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeConfigsResponse>("DescribeConfigsResponse", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeConfigsResponse) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeConfigsResponse", 1);
        }
    }
}
