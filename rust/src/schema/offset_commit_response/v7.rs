...
/// OffsetCommitResponse, version 7.
...
/// OffsetCommitResponseTopic, version 7.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// OffsetCommitResponsePartition, version 7.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetCommitResponse>("OffsetCommitResponse", 7);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetCommitResponse) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetCommitResponse", 7);
        }
    }
}
