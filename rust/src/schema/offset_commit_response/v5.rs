...
/// OffsetCommitResponse, version 5.
...
/// OffsetCommitResponseTopic, version 5.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
/// OffsetCommitResponsePartition, version 5.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<OffsetCommitResponse>("OffsetCommitResponse", 5);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: OffsetCommitResponse) {
            crate::test_utils::test_java_arbitrary(&data, "OffsetCommitResponse", 5);
        }
    }
}
