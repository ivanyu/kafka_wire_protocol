...
/// DescribeClusterRequest, version 1.
...
impl DescribeClusterRequest {
    pub fn new(include_cluster_authorized_operations: bool, endpoint_type: i8) -> Self {
        Self {
...
impl Readable for DescribeClusterRequest {
    fn read(#[allow(unused)] input: &mut impl Read) -> Result<Self> {
        ...
        Ok(DescribeClusterRequest {
            include_cluster_authorized_operations, endpoint_type, _unknown_tagged_fields
        })
    }
}
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<DescribeClusterRequest>("DescribeClusterRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: DescribeClusterRequest) {
            crate::test_utils::test_java_arbitrary(&data, "DescribeClusterRequest", 1);
        }
    }
}
