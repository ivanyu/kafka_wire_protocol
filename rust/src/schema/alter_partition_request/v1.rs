...
/// AlterPartitionRequest, version 1.
...
mod tests {
    ...
    fn test_java_default() {
        crate::test_utils::test_java_default::<AlterPartitionRequest>("AlterPartitionRequest", 1);
    }
    ...
    proptest! {
        ...
        fn test_java_arbitrary(data: AlterPartitionRequest) {
            crate::test_utils::test_java_arbitrary(&data, "AlterPartitionRequest", 1);
        }
    }
}
